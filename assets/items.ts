export default [
  ...
  {
    slug: 'degree-days-projected-statewide' as Slug,
  ...
  {
    slug: 'flammability-vegetation-current-conditions' as Slug,
  ...
  {
    slug: 'northern-climate-reports' as Slug,
  ...
  {
    slug: 'historical-sea-ice-atlas' as Slug,
  ...
  {
    slug: 'era-access-cds-api' as Slug,
  ...
  {
    slug: 'permafrost-observations-modeled-air-temp' as Slug,
    title:
  ...
  {
    slug: 'querying-daymet-daily-precipitation' as Slug,
  ...
  {
    slug: 'modeled-future-flammability' as Slug,
  ...
  {
    slug: 'historical-nrt-wildfire' as Slug,
    blurb:
  ...
  {
    slug: 'projected-permafrost-and-magt' as Slug,
  ...
  {
    slug: 'precipitation-frequency-chart' as Slug,
  ...
  {
    slug: 'heating-degree-days-chart' as Slug,
  ...
  {
    slug: 'freezing-index-chart' as Slug,
  ...
  {
    slug: 'thawing-index-chart' as Slug,
  ...
  {
    slug: 'very-cold-day-threshold-chart' as Slug,
  ...
  {
    slug: 'very-hot-day-threshold-chart' as Slug,
  ...
  {
    slug: 'summer-days-chart' as Slug,
  ...
  {
    slug: 'deep-winter-days-chart' as Slug,
  ...
  {
    slug: 'warm-spell-duration-index-chart' as Slug,
  ...
  {
    slug: 'cold-spell-duration-index-chart' as Slug,
