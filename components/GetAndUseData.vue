    ...
    <div class="content is-size-5">
      <ul>
        ...
        <li v-else-if="props.pointDataRegion">
          <a
            :href="`https://github.com/ua-snap/geospatial-vector-veracity/raw/main/vector_data/point/${props.pointDataRegion}_point_locations.csv`"
          >
