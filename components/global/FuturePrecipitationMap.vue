...
<template>
  ...
  <MapBlock mapId="precipitation">
    <template v-slot:layers>
      ...
      <MapLayer mapId="precipitation" :layer="layers[1]">
      ...
      <MapLayer mapId="precipitation" :layer="layers[2]">
      ...
      <MapLayer mapId="precipitation" :layer="layers[3]">
