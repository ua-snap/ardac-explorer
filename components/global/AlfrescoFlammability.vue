  ...
  <section class="section">
    <div class="content is-size-5">
      ...
      <p>
        ...
        point location. This chart displays mean flammability for five eras.
        Historical eras show model spinup outputs. Projected eras show ALFRESCO
        flammability outputs using the selected model and emissions scenario.
      </p>
      ...
      <div v-if="apiData">
        ...
        <div class="chart-input">
          <label for="return-interval" class="label">Scenario:</label>
          <div class="select">
            <select id="return-interval" v-model="scenarioInput">
              <option
      ...
      <div v-if="latLng" class="my-6">
        ...
        <p>
          ...
          charts above, but have not been converted into a percentage. In other
          words, a flammability value of 0.002 is equivalent to 0.2%
          flammability.
        </p>
        <ul>
          <li>
