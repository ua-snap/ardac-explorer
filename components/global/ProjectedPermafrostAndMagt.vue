...
<template>
  ...
  <p>
    ...
    mean annual ground temperature at seven different depths are provided by the
    GIPL 2.0 model for years 2021&ndash;2120. These projections are provided for
    GFDL CM3 and NCAR CCSM4 model outputs, as well as a 5-model average (GFDL
    CM3, NCAR CCSM4, GISS E2-R, IPSL CM5A-LR, MRI CGCM3), under the RCP 4.5 and
    RCP 8.5 emissions scenarios. Spatial resolution: 1&#8239;km.
  </p>
  <LatLngSelector />
    ...
    <ul>
      <li>
        <a
          :href="
            ...
            '/permafrost/point/gipl/63.0628/-146.1627?format=csv'
          "
          >Download as CSV</a
        >
      </li>
      <li>
        <a
          :href="
            runtimeConfig.public.apiUrl +
            '/permafrost/point/gipl/63.0628/-146.1627'
          "
          >Download as JSON</a
        >
      </li>
