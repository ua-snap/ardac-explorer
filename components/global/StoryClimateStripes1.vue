...
<template>
  <section class="section">
    <div class="content is-size-5">
      ...
      <p>The graphic is a great example of convergent ideas with two scientists at the University of Reading and another at the University of Georgia seemingly independently coming up with the idea. Here at the University of Alaska Fairbanks <a href="https://uaf-iarc.org/2022/07/iarcs-giant-climate-stripes-boldly-proclaim-arctic-change">IARC climate scientists like Rick Thoman and John Walsh</a> have been using them to tell stories about climate for years.</p>
      ...
      <p>Put it on a sticker or a wall and there you go; an arresting data visualization of temperature. The world’s getting warmer. But what else can we learn from these stripes by looking just a tiny bit closer?</p>

      </p>
      <h4>Similar trends are apparent over different temperature ranges</h4>
      <p>
        <p>Here’s a climate stripes graphic using gridded modeled historical data for Utqia&gdot;vik, the northernmost community in the United States on the north slope of Alaska:</p>
...
<p>...a shorter snow-machining season in Maine...</p><img src="assets/images/ClimateStripesStory1/ME-tavg.png">
<p> ...but 100°F+ summer days in Arizona straining the power grid...</p><img src="assets/images/ClimateStripesStory1/AZ-tavg.png">

      </p>

      <h4>Year-to-year variation is obvious, but trends are pronounced</h4>

      <p>Okay, let’s stick closer to home. Alaska’s state capitol, Juneau, is a very neat but also pretty unique place. Off the road system, the state’s 3rd largest city is surrounded by mountains, islands, and America’s largest national forest. Here are the climate stripes for Juneau:</p>
      ...
      <p>Overall though the trend is clear. Some warmer than average years do exist in the early 1900's and a few colder than average years occurred more recently, but overall a trend toward more red and less blue is obvious across the stripes. Year to year variability can be caused by specific storm patterns, recurring cycles like el ni&ntilde;o, or just plain chance. Understanding this variability is key to understanding why climate science comes with ranges and variability built in.</p>
      <p>The world is messy and our data should reflect that.</p>
      <h4>Try for yourself!</h4>
      <p>This module will let you create climate stripes for your part of Alaska. Maybe your home town, your hunting spot, your ethnolinguistic region, or even your lifelong favorite hydrological unit code level 10! Ours is 1908040302.</p>
      <p></p>
